...
public enum ErrorEnum {
     ...
     *
     * @param errorCode 错误码
     * @return com.hubz.common.response.v2.ErrorEnum
     **/
    public ErrorEnum errorCode2ErrorEnum(String errorCode) {
        if (CommonConstant.EMPTY_STRING.equals(errorCode)) {
            throw new RuntimeException("param errorCode is empty");
        }
